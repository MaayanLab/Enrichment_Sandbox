			...
			for l_tf in list(overlaps):
				...
				if len(dfs) == 1: dfs[0][l_tf] = result
					...
					for x in range(len(dfs)): 
						dfs[x][l_tf] = result[x]
						#print(dfs[x].at[0,l_tf]) #for diagnostics
...
if __name__ == '__main__':
	all_libs = ['Single_Gene_Perturbations_from_GEO_down', 'Single_Gene_Perturbations_from_GEO_up', 'ENCODE_TF_ChIP-seq_2015', 'ChEA_2016']
